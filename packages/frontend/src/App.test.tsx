...
describe('App', () => {
  it('renders manual inputs and batch CSV controls', () => {
    ...
    expect(screen.getByRole('heading', { name: /E-commerce CLV Predictor/i })).toBeInTheDocument();
  ...
  it('shows prediction results and the OOD warning banner', async () => {
    ...
    expect(screen.getByRole('alert')).toHaveTextContent('⚠️ Warning: I am not sure about this [prediction]!');
  });
